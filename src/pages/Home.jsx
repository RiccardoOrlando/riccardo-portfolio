...
export default function Home() {
  ...
  return (
    <>
      ...
      >
        <div className="w-full max-w-[90%] h-[95vh] bg-black/70 border border-red-600 shadow-[0_0_50px_#FF0000] rounded-4xl flex flex-col overflow-hidden py-8 px-8 my-20" style={{
